  ...
  return (
    <article className="ml-5 w-[43%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col items-center max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-col items-start self-stretch px-4 py-8 mt-8 w-full border border-solid border-black border-opacity-40 max-md:max-w-full">
          <ColorSelector
          ...
          <h3 className="mt-6 ml-3 text-base tracking-widest text-black uppercase max-md:ml-2.5">
            Description:
          </h3>

          <p className="mt-5 ml-3.5 text-xs tracking-wider text-black uppercase max-md:max-w-full">
